...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedActions_requestFeedFromLoader() {
        ...
        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 2, "Expected another loading request once user initiates reload")
        
        loader.completeFeedLoading(at: 1)
        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 3, "Expected another loading request once user initiates reload")
    ...
    func test_loadFeedCompletion_doesNotAlterCurrentrenderingStateOnError() {
       ...
       // let image1 = makeImage()
        ...
        sut.simulateLoadMoreFeedAction()
        loader.completeLoadMoreWithEror(at: 0)
        assertThat(sut, isRendering: [image0])
    ...
    func test_loadMoreCompletion_rendersErorMessageOnError() {
        ...
        loader.completeLoadMoreWithEror()
    ...
    func test_tapOnLoadMoreErrorView_LoadsMore() {
        ...
        sut.simulateTapOnLoaderMoreFeedError()
        XCTAssertEqual(loader.loadMoreCallCount, 1)
    ...
    func test_feedView_doesNotShowErrorMessageOnCompletionSuccess() {
    ...
    func test_loadMoreFeedCompletion_dispatchesFromBackgroundToMainThread()  {
    ...
    func test_feedImageView_doesNotLoadImageAgainUntilPreviosRequestCompletes() {
        ...
        sut.simulateFeedImageViewVisible(at: 0)
        XCTAssertEqual(loader.loadedImageURLs, [image.url], "Expected no request until previous comletes")
        ...
        sut.simulateFeedImageViewVisible(at: 0)
        XCTAssertEqual(loader.loadedImageURLs, [image.url, image.url, image.url], "Expected no request until previous comletes")
